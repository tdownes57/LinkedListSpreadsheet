...
Public Class FormSimpleDemo1D_Backup ''12/04/2024  FormSimpleDemoOfCSharp1D
    ''
    '' Added 10/14/2024 thomas c. downes 
    ''
    ''March2025  Private mod_manager As DLLOperationsManager1D(Of TwoCharacterDLLItem)
    ...
    Private Sub FormSimpleDemoOfCSharp1D_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Const LOAD_INSERT As Boolean = True
    ...
    Private Sub AutoPopulateRangeControls(par_range As DLLRange(Of TwoCharacterDLLItem))
        ...
        ''Added 11/12/2024 td
        ''
        Dim intRangeFirstIndex_b1 As Integer ''This is a 1-based index.
    ...
    Private Sub buttonDelete_Click(sender As Object, e As EventArgs) Handles buttonDelete.Click
        ...
        Dim type_notMove = New StructureTypeOfMove(False) ''Added 12/15/2024
