...
''Imports System.Text
''Public Class FormDemo1D_2DManager
''End Class
...
Public Class Form1Dmode2Dmanager ''12/04/2024  FormSimpleDemoOfCSharp1D
    ...
    Private Sub buttonInsertMulti_Click(sender As Object, e As EventArgs) Handles buttonInsertMultiple.Click
        ...
        ElseIf USE_OP_MANAGER And listInsertAfterOrBefore.SelectedIndex < 1 Then
            ...
            operation = New DLLOperation1D_Of(Of TwoCharacterDLLHorizontal)(mod_range, anchor_couple,
                                       INSERT_OPERATION, False, typeMove_isNull, False, False)
    ...
    Private Sub buttonInsertSingle_Click(sender As Object, e As EventArgs) Handles buttonInsertSingle.Click
        ...
        Const DIRECT_TO_LIST = False ''Added 10/26/2024 thom dow.nes
        Const INSERT_OPERATION = True '' False ''Added 10/26/2024 thomas downes
        Const ROTATE_L_FALSE As Boolean = False ''Added 12/24/2025
        Const ROTATE_R_FALSE As Boolean = False ''Added 12/24/2025
    ...
    Private Sub buttonDelete_Click(sender As Object, e As EventArgs) Handles buttonDelete.Click
        ...
        ''12/24/2024 Const SORT_UNDO As Boolean = False
        Const UNDO_SORT_ASCENDING As Boolean = False
        Const UNDO_SORT_DESCENDING As Boolean = False
    ...
    Private Sub LinkLabelUse2DManager_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabelUse2DManager.LinkClicked
    ...
    Private Sub LinkLabelUse1DManager_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabelUse1DManager.LinkClicked
