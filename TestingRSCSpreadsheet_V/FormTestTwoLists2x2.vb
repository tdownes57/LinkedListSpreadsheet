...
#ElseIf (USE_CSHARP_CLASS) Then ''Added 6/12/2024 td
    ...
    ''Leverage the derived subclasses. Hence you see, "(Of TwoCharacterDLLHorizontal)", etc.
    ''
    Private mod_listCS_1Cols As DLLList(Of TwoCharacterDLLHorizontal)
    Private mod_listCS_2Rows As DLLList(Of TwoCharacterDLLVertical)
...
#End If
    ...
    Public Sub New()
        ...
        Dim lastTwoCharH As New TwoCharacterDLLHorizontal("09") ''Columns are arranged horizontally related to one another.
        Dim lastTwoCharV As New TwoCharacterDLLVertical("09") ''Rows are are arranged vertically relative to one another.
...
#ElseIf USE_CSHARP_CLASS Then
        ''
        ''Added 8/04/2024  
        ''
        mod_listCS_1Cols = New DLLList(Of TwoCharacterDLLHorizontal)(firstTwoCharH, lastTwoCharH, 9)
        mod_listCS_2Rows = New DLLList(Of TwoCharacterDLLVertical)(firstTwoCharV, lastTwoCharV, 9)
...
#End If
    ...
    Private Sub FormTestTwoLists2x2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ''
        mod_list1Cols = New DLL_List_OfTControl_PLEASE_USE(Of TwoCharacterDLLHorizontal)()
        mod_list2Rows = New DLL_List_OfTControl_PLEASE_USE(Of TwoCharacterDLLVertical)()
