...
Public Class FormTestUsingManager
    ...
    Public Sub New()
        ...
        ''3/12/2024 userControlOperation1.DLL_ListHorizontal = mod_list
    ...
    Private Sub ProcessOperation_Delete(par_operationV1 As DLL_OperationV1,
        ...
        bChangeOfEndpoint = par_operationV1.IsChangeOfEndpoint
    ...
    ''' <summary>
    ''' This handles the event userControlOperation1.DLLOperationCreated_MoveRange
    ''' </summary>
    ''' <param name="par_operationV1"></param>
    ''' <param name="par_inverseAnchor_PriorToRange"></param>
    ''' <param name="par_inverseAnchor_NextToRange"></param>
