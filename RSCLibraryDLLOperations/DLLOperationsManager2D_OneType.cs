...
{
    //
    // Added 1/07/2025 and 10/12/2024 Thomas C. Downes
    //
    //    2D = 2-dimensional grid, Cartesian product
    ...
    //
    public class DLLOperationsManager2D_OneType<T_DLL>
        where T_DLL : class, IDoublyLinkedItem<T_DLL>
    {
        ...
        /// </summary>
        private DLLRange<T_DLL>[]? mod_arrayOfParallelRangesToInsert;
        ...
        /// a user to insert 5 new rows at any row-index location in a spreadsheet. 
        /// </summary>
        private DLLRange<T_DLL>[]? mod_arrayOfParallelRangesToDelete;
        ...
        private DLLOpsUndoRedoMarker1D<T_DLL>
            mod_opUndoRedoMarker;  // new DLLOperationsRedoMarker1D<T_DLL>(); // As r ''Added 1/24/2024
            ...
            DLLOperation1D_Of<T_DLL>? par_firstPriorOperationV1 = null)
        {
            ...
            if (par_firstPriorOperationV1 == null) // Added 4/11/2025 
            {
                ...
                // Added 4/11/2025 
                //----mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1DParallel<T_DLL, T_DLL>();
        ...
        public void ProcessOperation_PrimaryAndParallel(DLLOperation1D_Of<T_DLL> parOperation,
                       bool par_changeOfEndpoint_Expected,
                       out bool par_changeOfEndpoint_Occurred,
                       bool pbOperationIsNewSoRecordIt,
                       DLLOperationIndexStructure parOperationIndexed,
                       bool pbOnlyExecuteToPrimaryList)
        {
            ...
            DLLRange<T_DLL>[]? array_of_insertRangesParallel;
            ...
            else if (pbOperationIsNewSoRecordIt)
            {
                ...
                if (mod_firstPriorOperation1D == null)
                {
                    ...
                    // mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1DParallel<T_DLL, T_DLL>(parOperation, false);
                ...
                else
                {
                    ...
                    //April2025  mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1D<T_DLL>(parOperation);
                    //mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1DParallel<T_DLL, T_DLL>(parOperation, false);
                    mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1D<T_DLL>(parOperation);  //, false);
                               ...
                               bool pbOnlyExecuteOnPrimaryList = false)
        {
            ...
            //    DLLOperation1D<T_DLL> each_operation = new DLLOperation1D<T_DLL>
        ...
        public void ProcessOperation_ToParallelList(DLLList<T_DLL> par_listParallelToProcessFirst,
                       DLLOperation1D_Of<T_DLL> parOperation,
                       bool par_changeOfEndpoint_Expected,
                       out bool par_changeOfEndpoint_Occurred,
                       bool pbOperationIsNewSoRecordIt,
                       DLLOperationIndexStructure parOperationIndexed,
        ...
        // where TControl: class, IDoublyLinkedItem<TControl>
        {
            ...
            if (mod_firstPriorOperation1D == null)
            {
                ...
                //mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1DParallel<T_DLL, T_DLL>(mod_firstPriorOperation1D, false);
                mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1D<T_DLL>(mod_firstPriorOperation1D);  //, false);
            ...
            else
            {
                ...
                //    T_DLL>(mod_lastPriorOperation1D, false);
                mod_opUndoRedoMarker = new DLLOpsUndoRedoMarker1D<T_DLL>
                    (mod_lastPriorOperation1D);  //, false);
        ...
        public void RedoMarkedOperation(ref bool pbEndpointAffected, bool pbTestingIndexStructure) // (bool pbIsHoriz, bool pbIsVerti)
        {
            ...
            //DLLOperation1D_2TypesInParallel<T_DLL, T_DLL>  // <T_DLLHor, T_DLLVer>
            //    opReDo_OfOf = mod_opUndoRedoMarker.GetCurrentOp_Redo_OfOf();
            DLLOperation1D_Of<T_DLL>  // <T_DLLHor, T_DLLVer>
                opReDo_Of = mod_opUndoRedoMarker.GetCurrentOp_Redo();

            //Added 4/23/2025 td
            mod_arrayOfParallelRangesToDelete = opReDo_Of.GetArrayOfParallelRanges_Deleted();
            mod_arrayOfParallelRangesToInsert = opReDo_Of.GetArrayOfParallelRanges_ToInsert();

            //Added 5.25.2024
            //bool bIsChangeOfEndpoint = opReDo.IsChangeOfEndpoint();
            bool bChangeOfEndpoint_Expected = opReDo_Of.IsChangeOfEndpoint();
            ...
            ProcessOperation_AnyType(opReDo_Of, bChangeOfEndpoint_Expected,
                out bChangeOfEndpoint_Occurred, RECORD_OPERATION,
                opReDo_Of.GetOperationIndexStructure(false, true)); // , pbIsHoriz, pbIsVerti);
        ...
        public void ClearAnyRedoOperations_IfQueued()
        {
            ...
            if (bMustRemoveOneOrMoreOpsQueuedForRedo)
            {
                ...
                //DLLOperation1D_2TypesInParallel<T_DLL, T_DLL>? markersCurrentUndoOperation_willBeLast;
                DLLOperation1D_Of<T_DLL>? markersCurrentUndoOperation_willBeLast;
        ...
        ///   each list being of the parallel type (T_DLL, e.g. RSCDataColumn).
        /// </summary>
        ...
        private void ProcessOperation_ToArrayOfParallelLists(DLLOperationIndexStructure par_operationStructure,
            ...
            DLLList<T_DLL>? par_listThatWasAlreadySorted = null)
        {
            //
            //This will propagate an operation to the local array of DLLLists,
            ...
            {
                // Added 4/14/2025 
                mod_arrayOfParallelRangesToDelete = new DLLRange<T_DLL>[countOfParallelLists];
            }
